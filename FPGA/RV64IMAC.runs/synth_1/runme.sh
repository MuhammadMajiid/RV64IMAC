...
HD_PWD='C:/Users/majii/Documents/Vivado/RV64IMAC/RV64IMAC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log riscv_core_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source riscv_core_top.tcl
